...
# ------
    ...
    if reset_spectrum: rc.spectrum_reset()
...
# -------
    ...
    fig.suptitle('Radiacode Spectrum   ' + time.asctime(),
                  size='large', color='b')
    ...
    axE.set_xlim(0., Energies[NChannels-1])
    ...
    axEdiff.set_xlim(0., Energies[NChannels-1])
    plt.locator_params(axis='x', nbins=12)
  ...
  # text for active time and statistiscs
    text_active = axE.text(0.8, 0.94, '     ',
                    transform=axE.transAxes,
                    color='darkred',
                   # backgroundcolor='white', 
                    alpha=0.7)
    text_statistics = axE.text(0.75, 0.8, '     ',
                    transform=axE.transAxes,
                    color='darkblue',
                   # backgroundcolor='white', 
                    alpha=0.7)    
    ...
    while True:
      ...
      # update graphics
        ...
        print(toggle[itoggle], ' active:', dT, 's  ',
